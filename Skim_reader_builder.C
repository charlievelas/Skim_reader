...
for (int var_indx=0; var_indx<var_name_vect.size(); var_indx++){    
    ...
    outFile << "tree->Branch(\"" + var_name_vect.at(var_indx) + "_PID\",&" + var_name_vect.at(var_indx) + "_Pz);" << endl;
    outFile << "tree->Branch(\"" + var_name_vect.at(var_indx) + "_Beta\",&" + var_name_vect.at(var_indx) + "_Pz);" << endl;
    outFile << "tree->Branch(\"" + var_name_vect.at(var_indx) + "_chi2PID\",&" + var_name_vect.at(var_indx) + "_Pz);" << endl;
...
for (int var_indx=0; var_indx<var_name_vect.size(); var_indx++){
    ...
    outFile << "        MissMass2_" + var_name_vect.at(var_indx) + " = miss_LV_" + var_name_vect.at(var_indx) + ".M();" << endl;
}
